...
\frametitle{Sprint 1 - Hauptmenu}
  \begin{block}{Extraktion aus Product Backlog}
   ...
   \item Design des Hauptmenu
    ...
    \item Integration der Sprachen Englisch, Spanisch, Franzoesisch
    \end{itemize}
  \end{block}  
...
\subsection*{Sprint 5}
\frame{
\frametitle{Sprint 5 - Optionsmenu}
  \begin{block}{Extraktion aus Product Backlog}
    \begin{itemize}
...
\subsection*{Sprint 6}
\frame{
\frametitle{Sprint 6 - Redesign}
  \begin{block}{Entscheidung des PO - Chinesische Sprache hinzufuegen}
  \end{block}
  \begin{block}{Extraktion aus Product Backlog}
    \begin{itemize}
    \item Chinesische Uebersetzung für alle Texte erstellen
    \item Optionsmenu um chinesisch erweitern
    \end{itemize}
  \end{block}  
